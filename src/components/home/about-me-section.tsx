        ...
        <div className='flex flex-col gap-12 md:flex-row'>
          <div className='basis-3/5'>
            <p className='mb-4'>
              ...
              passion for creating things that live on the internet. My journey
              in web development has led me to specialize in React.js and
              Next.js, where I focus on building accessible, inclusive products
            ...
            <p className='mb-4'>
              ...
              cross-functional teams has taught me the value of collaboration
              and agile methodologies in delivering successful projects.
            </p>
            <p className='mb-4'>
